...
var CarGroupManager = require('CarGroupManager');
...
var GameManager = cc.Class({
    ...
    properties: {
        ...
        carGroupManager: CarGroupManager,
        //-- 获取gameOverMenu对象
    ...
    onLoad () {
        ...
        //this.person.init(this);
        this.pipeGroupMgr.init(this);
        this.carGroupManager.init(this);
    ...
    start () {
        ...
        this.carGroupManager.startSpawn();
        this.sheep.startRun();
        //this.person.startRun();
    },
    gameOver () {
        //-- 背景音效停止，死亡音效播放
